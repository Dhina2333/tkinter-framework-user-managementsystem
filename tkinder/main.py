...
root=Tk()
root.title("Team Members Mangement System")
...
title=Label(entries_frame,text="Team Members Mangement System",font=("calibri",18,"bold"),bg="#535c68",fg="white")
...
def add_member():
    ...
    messagebox.showinfo("Sucess","Details Added")
    clearAll()
    dispalyAll()
...
def update_member():
    ...
    messagebox.showinfo("Sucess","Details Updated")
    clearAll()
    dispalyAll()
...
btnAdd=Button(btn_frame,command=add_member,text="Add Details",width=15,font=("calibri",16,"bold"),bg="#16a085",fg="white",bd=0).grid(row=0,column=0)

btnEdit=Button(btn_frame,command=update_member,text="Update Details",width=15,font=("calibri",16,"bold"),bg="#2980b9",fg="white",bd=0).grid(row=0,column=1,padx=10)


btnDelete=Button(btn_frame,command=delete_member,text="Delete Details",width=15,font=("calibri",16,"bold"),bg="#c0392b",fg="white",bd=0).grid(row=0,column=2,padx=10)
...
tree_frame.place(x=0,y=475,width=1366,height=250)
style=ttk.Style()
